...
namespace HockeyAppDownload
{
	...
	/// </summary>
	/// <remarks>Original code from here (http://www.blackbeltcoder.com/Articles/files/reading-and-writing-csv-files-in-c).
	/// I've made a few tweaks.</remarks>
	...
	public class CsvFileWriter : CsvFileCommon, IDisposable
	{
		...
		public CsvFileWriter(string path, string[] columnNames)
		{
		...
		public void WriteRow(string[] columns)
		{
			...
			{
				string column = columns[i] ?? string.Empty;
